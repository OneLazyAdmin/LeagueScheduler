...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.chosen_league_combo.setInsertPolicy(QtWidgets.QComboBox.InsertPolicy.InsertAlphabetically)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.picture_label)
        self.timezone_title = QtWidgets.QLabel(self.Settings)
        self.timezone_title.setObjectName("timezone_title")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.timezone_title)
        self.timezone = QtWidgets.QComboBox(self.Settings)
        self.timezone.setObjectName("timezone")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.timezone)
        self.get_timeoffset = QtWidgets.QPushButton(self.Settings)
        self.get_timeoffset.setObjectName("get_timeoffset")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.get_timeoffset)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.chosen_week_title.setText(_translate("MainWindow", "Block"))
